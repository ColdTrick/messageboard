...
$(document).ready(function(){
    ...
    $("#postit").click(function(){
        if($("[name=name]").val() == ""){
			alert('<?php echo elgg_echo("messageboard:noname");?>');
			return false;
		}
		if($("[name=message_content]").val() == ""){
			alert('<?php echo elgg_echo("messageboard:blank");?>');
			return false;
		}
        ...
        $("#messageboard_wrapper").load("<?php echo $vars['url']; ?>mod/messageboard/ajax_endpoint/load.php", {messageboard_content:$("[name=message_content]").val(), guid:"<?php echo $_SESSION['guid']; ?>", pageOwner:$("[name=pageOwner]").val(), name: $("[name=name]").val(), numToDisplay:<?php echo $num_display; ?>}, function(){
...
<div id="mb_input_wrapper"><!-- start of mb_input_wrapper div -->
	...
	<?php } else { 
		...
		<b><?php echo elgg_echo("messageboard:name");?></b>
